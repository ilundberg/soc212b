...
tibble(id = 1:6) |>
  ...
  mutate(value = ifelse(value,"Missing","Not Missing")) |>
  ...
  scale_x_discrete(name = "Variable", position = "top") +
  scale_y_continuous(name = "Case ID", breaks = 1:6, labels = 6:1) +
  annotate(geom = "segment", x = 1:5 - .5, xend = 1:5 - .5, y = .5, yend = 6.5,
           color = "gray", linewidth = .7) +
  annotate(geom = "segment", x = .5, xend = 4.5, y = 1:7 - .5, yend = 1:7 - .5,
           color = "gray", linewidth = .7) +
  theme_minimal() +
