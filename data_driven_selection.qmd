...
> If you are taking notes, here is a PDF of the [slides](slides/lec4/data_driven_selection_slides_handout.pdf) and a PDF of [this page](slides/lec4/data_driven_selection_chapter.pdf).
...
forplot |>
  ...
  theme_void()
ggsave("slides/lec4/figures/five_folds.pdf", height = 3, width = .8)
for (i in 1:5) {
  ...
  ggsave(paste0("slides/lec4/figures/five_folds_",i,".pdf"), height = 3, width = .8)
}
