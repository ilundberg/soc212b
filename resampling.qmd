...
> Here are [slides](slides/lec6/resampling_slides.pdf) and a [PDF of this page](assets/pdf_chapters/resampling.pdf). Notation and ideas on this page loosely draw on [Efron \& Hastie (2016)](https://hastie.su.domains/CASI/) Ch 10--11.
...
```{r, echo = F, cache = T}
many_stratified_samples <- foreach(rep = 1:5000, .combine = "c") %do% {
